...
[Fabric 体验概述 [5](#fabric-体验概述)](#fabric-体验概述)

[任务 2：Data Factory 体验
[5](#任务-2data-factory-体验)](#任务-2data-factory-体验)

[任务 3：Data Activator 体验
[7](#任务-3data-activator-体验)](#任务-3data-activator-体验)

[任务 4：Synapse Data Engineering 体验
[7](#任务-4synapse-data-engineering-体验)](#任务-4synapse-data-engineering-体验)

[任务 5：Synapse Data Science 体验
[8](#任务-5synapse-data-science-体验)](#任务-5synapse-data-science-体验)

[任务 6：Synapse Data Warehouse 体验
[10](#任务-6synapse-data-warehouse-体验)](#任务-6synapse-data-warehouse-体验)

[任务 7：Real-Time Analytics 体验
[11](#任务-7real-time-analytics-体验)](#任务-7real-time-analytics-体验)

[Fabric 工作区 [12](#fabric-工作区)](#fabric-工作区)

[任务 8：创建 Fabric 工作区
[12](#任务-8创建-fabric-工作区)](#任务-8创建-fabric-工作区)

[任务 9：创建 Lakehouse
[14](#任务-9创建-lakehouse)](#任务-9创建-lakehouse)
...
![](./media/image6.png){width="2.9786439195100614in"
height="2.6326924759405075in"}

3.  您将导航到**密码**屏幕。输入讲师与您共享的密码。

4.  点击**登录**并按照提示登录 Fabric。

![](./media/image7.png){width="2.7584470691163605in"
height="2.299753937007874in"}
...
![](./media/image8.png){width="5.056205161854768in"
height="1.845660542432196in"}

9.  "升级到 Microsoft Fabric
    免费试用版"对话框随即打开。选择**开始试用**。

![](./media/image9.png){width="6.184421478565179in"
height="1.6558278652668417in"}

10. "已成功升级到Microsoft Fabric 免费试用版"对话框随即打开。选择
    **Fabric 主页**。

![](./media/image10.png){width="3.0in" height="1.0762325021872265in"}

11. 您将导航到 **Microsoft** **Fabric 主页**。

![](./media/image11.png){width="6.095606955380577in"
height="3.0509787839020124in"}
...
![](./media/image12.png){width="6.041185476815398in"
height="4.157375328083989in"}
...
![](./media/image13.png){width="2.7294225721784775in"
height="2.7951924759405076in"}

### 任务 3：Data Activator 体验

1.  选择屏幕左下角的 **Data Factory**。Fabric 体验对话框随即打开。

![](./media/image14.png){width="2.0in" height="3.1894477252843396in"}
...
![](./media/image15.png){width="2.634595363079615in"
height="1.6968580489938758in"}
...
![](./media/image16.png){width="6.085691163604549in"
height="4.24315179352581in"}
...
![](./media/image17.png){width="5.97917104111986in"
height="5.593794838145232in"}
...
![](./media/image18.png){width="2.840814741907262in"
height="4.863435039370079in"}
...
![](./media/image19.png){width="2.815308398950131in"
height="3.1288462379702535in"}
...
![](./media/image20.png){width="1.6067104111986001in"
height="3.767325021872266in"}
...
![](./media/image21.png){width="2.9243055555555557in"
height="2.756476377952756in"}

7.  在**许可证模式**下，确保选择**试用版**。（这应该已默认选中。）

8.  选择**应用**以创建新工作区。

![](./media/image22.png){width="3.0in" height="2.2164938757655293in"}
...
![](./media/image23.png){width="1.2309328521434821in"
height="3.3066251093613297in"}

3.  选择 **Lakehouse**。

![](./media/image24.png){width="6.111996937882765in"
height="1.8741338582677165in"}
...
![](./media/image25.png){width="2.9590069991251093in"
height="1.581081583552056in"}
...
![](./media/image26.png){width="6.158403324584427in"
height="2.854371172353456in"}
...
![](./media/image27.png){width="1.9311406386701662in"
